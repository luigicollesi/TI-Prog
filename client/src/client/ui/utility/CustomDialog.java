...
public class CustomDialog {
    ...
    public static int showConfirm(Component parent, String message, String title) {
        ...
        JDialog dialog = new JDialog((Frame) SwingUtilities.getWindowAncestor(parent), title, true);
        dialog.setUndecorated(true);
        dialog.setSize(new Dimension(520, 260));
        dialog.setLocationRelativeTo(parent);
        ...
        lblMsg.setFont(new Font("Arial", Font.BOLD, 22));
        lblMsg.setForeground(Color.WHITE);
        lblMsg.setBorder(BorderFactory.createEmptyBorder(15, 0, 0, 0));
        messageBox.add(lblMsg);
        ...
        JButton btnYes = new RoundButton("Sim", Color.BLACK);
        btnYes.setPreferredSize(new Dimension(150, 50));
        btnYes.addActionListener(e -> {
            result[0] = JOptionPane.YES_OPTION;
            dialog.dispose();
        });

        JButton btnNo = new RoundButton("Não", Color.BLACK);
        btnNo.setPreferredSize(new Dimension(150, 50));
